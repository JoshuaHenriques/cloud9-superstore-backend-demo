...
//        assertThrows(InvalidItemException.class, () -> onlineInventoryController.add(null, null, 0, 0.00));
//    }
...
//
//        assertThrows(ItemAlreadyExistsException.class, () -> onlineInventoryController.add(item, uuid, quantity, item.getPrice() * quantity));
//    }
...
//        assertThrows(InvalidItemException.class, () -> onlineInventoryController.update(null));
//    }
...
//
//        assertThrows(ItemNotFoundException.class, () -> onlineInventoryController.update(inventory));
//    }
    ...
    void getByIdThrowsItemNotFoundException() {
        ...
        assertThrows(ItemNotFoundException.class, () -> onlineInventoryController.getById(uuid));
    }
    ...
    void removeInventoryThrowsInvalidItemException() {
        assertThrows(InvalidItemException.class, () -> onlineInventoryController.delete(null));
    }
    ...
    void removeInventoryThrowsItemNotFoundException() {
        ...
        assertThrows(ItemNotFoundException.class, () -> onlineInventoryController.delete(uuid));
    }
